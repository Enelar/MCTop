...
<html lang="ru">
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a id="mctop_logo" class="navbar-brand" onclick="display_page('main','index')"> <span class="glyphicon glyphicon-home"></span> <?php echo Core::get_settings()->application['site_name']?></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <?php if(Core::is_user_authorized()):?>
                        ...
                        ?>
                        <li><a onclick="show_profile('<?php echo $user_profile->id;?>')"> <span class="glyphicon glyphicon-user"></span> Профиль</a></li>
                    <?php endif?>
                </ul>
                <?php if(Core::is_user_authorized()):?>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a onclick="display_page('control_panel','index')"><span class="glyphicon glyphicon-plane"></span> Контрольная панель</a></li>
                                <li><a onclick="display_page('community','index')"><span class="glyphicon glyphicon-globe"></span> Сообщество</a></li>
                                <li class="divider"></li>
    ...
    <?php if(Core::is_user_authorized()):?>
        <?php if(Clubs::get_current_user_invitations_count()>0):?>
